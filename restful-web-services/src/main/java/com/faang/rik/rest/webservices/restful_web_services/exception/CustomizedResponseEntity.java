package com.faang.rik.rest.webservices.restful_web_services.exception;
...
public class CustomizedResponseEntity extends ResponseEntityExceptionHandler {
	...
	protected ResponseEntity<Object> handleMethodArgumentNotValid(
		...
		ex.getFieldErrors().forEach(exe->errors.append("Field: ")
				.append(exe.getField()).append(": ")
				.append(exe.getDefaultMessage()).append(". "));	
